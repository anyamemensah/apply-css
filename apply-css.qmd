...
`[This sentence is wrapped in a span tag and is written in Roboto font with a font size of 3.5em.]{.bigFont}`  
...
`[This text is wrapped in a span tag and is written in Montserrat font with a font size of 2em.]{.anotherFont}`  
